...
from layers.extractor import MultiScaleExtractor, MultiScaleCombiner_V2
from transform.analysis import AnalysisTransform_L1, AnalysisTransform_L2, AnalysisTransform_L3, HyperAnalysis
from transform.synthesis import SynthesisTransform_L1_V2, SynthesisTransform_L2_V2, SynthesisTransform_L3_V2, HyperSynthesis
...
class MSLIC_V2(CompressionModel):
    ...
    def __init__(self, N=192, M=336, num_slices=7, **kwargs):
        ...
        self.ms_combiner  = MultiScaleCombiner_V2 (dim = 48, num_blocks = [4,6,6], heads = [1,2,4])
        ...
        self.g_s_level_1 = SynthesisTransform_L1_V2(OutDim=96 , N=144, M=192)
        self.g_s_level_2 = SynthesisTransform_L2_V2(OutDim=96 , N=96 , M=96 )
        self.g_s_level_3 = SynthesisTransform_L3_V2(OutDim=192, N=96 , M=48 )
