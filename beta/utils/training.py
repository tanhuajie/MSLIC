        ...
        if i % 100 == 0:
            if out_criterion["ms_ssim_loss"] is None:
                logger_train.info(
                    ...
                    f'DS1 loss: {out_criterion["mse_loss_ds1"].item():.4f} | '
                    f'DS2 loss: {out_criterion["mse_loss_ds2"].item():.4f} | '
                    f'DS4 loss: {out_criterion["mse_loss_ds4"].item():.4f} | '
                ...
                logger_train.info(
                    ...
                    f'Bpp loss: {out_criterion["bpp_loss"].item():.2f} | '
                    f'DS1 loss: {out_criterion["ms_ssim_loss_ds1"].item():.4f} | '
                    f'DS2 loss: {out_criterion["ms_ssim_loss_ds2"].item():.4f} | '
                    f'DS4 loss: {out_criterion["ms_ssim_loss_ds4"].item():.4f} | '
                    f"Aux loss: {aux_loss.item():.2f}"
                )
