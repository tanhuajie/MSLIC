...
from transform.synthesis import SynthesisTransform_L1, SynthesisTransform_L2, SynthesisTransform_L3, HyperSynthesis, SynthesisTransform
...
class MSLIC_PLUS(CompressionModel):
    ...
    def __init__(self, N=192, M=336, num_slices=7, **kwargs):
        ...
        self.ms_extractor = MultiScaleExtractor(dim = 48, num_blocks = [2,3,3,4], heads = [2,2,4,8])
        # self.ms_combiner  = MultiScaleCombiner (dim = 48, num_blocks = [2,3,3], heads = [2,2,4])
        ...
        self.g_s = SynthesisTransform(N=self.N, M=self.M)
